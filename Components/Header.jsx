...
const Header = ({
    ...
    const handleAccountsChanged =(acccounts)=>{
        setAddress(acccounts[0]);
    }
            ...
            <ul className="menu">
               ...
               <li>
                <a onClick={() => openICOMarketplace
                  ...
                  : setOpenICOMarketplace(true) }>Created ICO</a>
               </li>

               <li>
                <a onClick={() => openAllICO
                   ? setOpenAllICO(false)
                  : setOpenAllICO(true) }>ICO MarketPlace</a>
               </li>

               <li>
                <a onClick={() => openTokenHistory
                   ? setOpenTokenHistory(false)
                  : setOpenTokenHistory(true) }>History</a>
               </li>

               <li>
                <a onClick={() => openTokenCreator
                   ? setOpenTokenCreator(false)
                  : setOpenTokenCreator(true) }>Create Token</a>
               </li>
